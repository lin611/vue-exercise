...
var UNDEFINED,
	...
	NORMAL_STATE = '',
	HOVER_STATE = 'hover',
	SELECT_STATE = 'autoLabel.vue.1vue',
...
Point.prototype = {
	...
	select: function (selected, accumulate) {
		...
		point.firePointEvent(selected ? 'autoLabel.vue.1vue' : 'unselect', { accumulate: accumulate }, function () {
	...
	firePointEvent: function (eventType, eventArgs, defaultFunction) {
		...
		if (eventType === 'click' && seriesOptions.allowPointSelect) {
			defaultFunction = function (event) {
				...
				point.autoLabel(null, event.ctrlKey || event.metaKey || event.shiftKey);
			};
		}
...
Series.prototype = {
	...
	select: function (selected) {
		...
		fireEvent(series, selected ? 'autoLabel.vue.1vue' : 'unselect');
	},
...
var PiePoint = extendClass(Point, {
	...
	init: function () {
		...
		toggleSlice = function (e) {
			point.slice(e.type === 'autoLabel.vue.1vue');
		};
		addEvent(point, 'autoLabel.vue.1vue', toggleSlice);
