const PRINTER= {
  HANDLE: (function (win) {
    var CLODOP = {
      strWebPageID:"JL68K76",strTaskID:"",strHostURI:"http://localhost:8000",
      VERSION:"6.2.2.0",IVERSION:"6220",CVERSION:"3.0.0.8",HTTPS_STATUS:0,VERSION_EXT:true,
        ...
        function() {
          ...
          try {
            if (!this.webskt || this.webskt.readyState==3) {
              ...
              this.webskt=new WebSocket('ws://localhost:8000/c_webskt/');
